...
const Team = () => {
  const member = [
    {
      photo: "https://avatars.githubusercontent.com/u/144203522?v=4",
      name: "DINESH V A",
      title: "Full-Stack Developer",
      bio: "I have expertise in full-stack web development, Machine Learning, and MERN stack development. I am knowledgeable in various programming languages, frameworks, and technologies and strive to create high-quality, user-friendly applications.",
    },
  ];
  return (
    <TeamWrapper id="team">
